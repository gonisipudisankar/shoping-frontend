  ...
  return (
    <div className="bg-gray-100 min-h-screen p-5">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded shadow p-6 mb-4">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full py-3 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded text-sm">
              ✅ Place Order
            </button>
          </div>
        </div>
        ...
        {/* Success */}
        {orderPlaced && (
          <div className="bg-green-50 border border-green-200 rounded p-5 mb-4 text-center">
            <p className="text-green-700 text-lg font-semibold">
              🎉 Order Placed Successfully!
            </p>
            <button
              onClick={() => navigate('/')}
              className="mt-3 px-6 py-2 bg-blue-600 text-white rounded font-medium hover:bg-blue-700">
              Continue Shopping
            </button>
          </div>
        )}
